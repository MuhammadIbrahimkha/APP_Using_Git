...
Console.WriteLine("I've just started with Git and made the first Repository Successful.");
...
Console.WriteLine("Hmmm! Changes... from Github Repository to Visual Studio");
